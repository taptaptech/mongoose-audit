...
module.exports = function historyPlugin(schema, options) {
    ...
    var saveHistory = function saveHistory(doc, operation, date, next) {
        var collection = doc.constructor && doc.constructor.collection;
    ...
    /**
     * We define some helpers for an easier explicit usage
     */
    schema.statics.logPartialUpdate = function(doc) {
        schema.statics.logPartialChange(doc, 'update', new Date());
    };
